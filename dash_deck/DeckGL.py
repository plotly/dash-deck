...
- clickEvent (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
 This prop is updated when an element in the map is clicked. This contains
the original gesture event (in JSON).
- clickInfo (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
 This prop is updated when an element in the map is clicked. This contains
the picking info describing the object being clicked.

Complete description here:
https://deck.gl/docs/developer-guide/interactivity#the-picking-info-object
- hoverEvent (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
 This prop is updated when an element in the map is hovered. This contains
the original gesture event (in JSON).
- hoverInfo (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
 This prop is updated when an element in the map is hovered. This contains
the picking info describing the object being hovered.

Complete description here:
https://deck.gl/docs/developer-guide/interactivity#the-picking-info-object
- dragStartEvent (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
...
the original gesture event (in JSON).
- dragStartInfo (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
...
Complete description here:
https://deck.gl/docs/developer-guide/interactivity#the-picking-info-object
- dragEndEvent (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
 This prop is updated when the user releases from dragging the canvas. This contains
the original gesture event (in JSON).
- dragEndInfo (dict; optional): Read-only prop. To use this, make sure that enableEvents is set to True, or that enableProps is a list that contains this event type.
 This prop is updated when the user releases from dragging the canvas. This contains
the picking info describing the object being dragged.
...
https://deck.gl/docs/developer-guide/interactivity#the-picking-info-object"""
    @_explicitize_args
    def __init__(self, data=Component.UNDEFINED, id=Component.UNDEFINED, enableEvents=Component.UNDEFINED, tooltip=Component.UNDEFINED, mapboxKey=Component.UNDEFINED, clickEvent=Component.UNDEFINED, clickInfo=Component.UNDEFINED, hoverEvent=Component.UNDEFINED, hoverInfo=Component.UNDEFINED, dragStartEvent=Component.UNDEFINED, dragStartInfo=Component.UNDEFINED, dragEndEvent=Component.UNDEFINED, dragEndInfo=Component.UNDEFINED, **kwargs):
        self._prop_names = ['data', 'id', 'enableEvents', 'tooltip', 'mapboxKey', 'clickEvent', 'clickInfo', 'hoverEvent', 'hoverInfo', 'dragStartEvent', 'dragStartInfo', 'dragEndEvent', 'dragEndInfo']
        self._type = 'DeckGL'
        self._namespace = 'dash_deck'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['data', 'id', 'enableEvents', 'tooltip', 'mapboxKey', 'clickEvent', 'clickInfo', 'hoverEvent', 'hoverInfo', 'dragStartEvent', 'dragStartInfo', 'dragEndEvent', 'dragEndInfo']
